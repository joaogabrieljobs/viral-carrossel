...
| ID | Decisão |
|---|---|
| D-01 | **Imagem** via plataforma (SJinn → GPT Image 2). **Texto incluso** via Z.ai no servidor (`ZAI_API_KEY`). BYOK de texto só se o user escolher outro provedor. |
...
|---|---|---|---|---|---|
| **Essencial** | R$ 19,90 | 0 | Incluso (Z.ai) | Não (só upload) | Sim, em Configurações |
| **Criador** | R$ 97 | 50 | Incluso (Z.ai) | Sim (SJinn) | Sim, em Configurações |
| **Pro** | R$ 197 | 150 | Incluso (Z.ai) | Sim (SJinn) | Sim, em Configurações |
| **Max** | R$ 297 | 300 | Incluso (Z.ai) | Sim (SJinn) | Sim, em Configurações |
...
- **RF-08:** Texto incluso no plano via Z.ai no servidor (`ZAI_API_KEY`); BYOK de texto opcional (Anthropic/OpenAI/Kimi) em Configurações.
