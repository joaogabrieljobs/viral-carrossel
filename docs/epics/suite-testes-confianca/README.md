...
|---|---|---|---|---|---|
| 01 | walking-skeleton-vitest-ci | `npm test` roda Vitest com 1 teste real de `api/lib/access.js` (token válido + adulterado) passando local e no GitHub Actions | RF-04 (parcial) · DEC-001, DEC-007 | — | ⬜ |
| 02 | unit-utils-puros | Testes de `src/utils/*` (parsers, formats, schema-migration, brand-helpers, hooks-library, wcag, slide-design-system) + `src/lib/billing.js` | RF-03 | 01 | ⬜ |
